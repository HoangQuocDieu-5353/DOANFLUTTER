...
const String productByCategoryScreenRoute = '/product_by_category';
const String adminDashboardScreenRoute = '/admin-dashboard';
...
const String ordersScreenRoute1 = "orderscreens"; 
const String returnOrderScreenRoute = "return_order";
const String returnDetailsScreenRoute = '/return-details';
const String adminOrdersScreenRoute = '/admin-orders';
const String reviewManagementScreenRoute = '/admin/reviews';
